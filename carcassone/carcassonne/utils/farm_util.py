...
from carcassone.carcassonne.objects.coordinate_with_farmer_side import CoordinateWithFarmerSide
...
from carcassone.carcassonne.utils.side_modification_util import SideModificationUtil
