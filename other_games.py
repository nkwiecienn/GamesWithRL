...
def train_action_mask(env_fn, steps=10_000, seed=0, **env_kwargs):
    ...
    env_name = env.metadata.get("name", "unknown_env")
...
def eval_action_mask(env_fn, num_games=100, render_mode=None, is_random=True, is_deterministic=True, **env_kwargs):
...
if __name__ == "__main__":
    ...
    eval_action_mask(env_fn, num_games=2, render_mode="human", is_random=False, is_deterministic=True, **env_kwargs)
